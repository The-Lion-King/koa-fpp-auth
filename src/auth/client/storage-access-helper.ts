const storageAccessHelper = `(function() {
      ...
      StorageAccessHelper.prototype.redirectToAppTLD = function(storageAccessStatus) {
        ...
        data = JSON.stringify({
          message: 'Fpp.API.remoteRedirect',
          data: {
            location: normalizedLink.href,
          }
        });
        window.parent.postMessage(data, this.redirectData.myFppUrl);
      }

      StorageAccessHelper.prototype.redirectToAppsIndex = function() {
        window.parent.location.href = this.redirectData.myFppUrl + '/admin/apps';
      }
      ...
      StorageAccessHelper.prototype.grantedStorageAccess = function() {
        try {
          sessionStorage.setItem('fpp.granted_storage_access', true);
          this.setCookie('fpp.granted_storage_access=true');
          if (!document.cookie) {
      ...
      StorageAccessHelper.prototype.handleHasStorageAccess = function() {
        if (sessionStorage.getItem('fpp.granted_storage_access')) {
      ...
      StorageAccessHelper.prototype.handleGetStorageAccess = function() {
        if (sessionStorage.getItem('fpp.top_level_interaction')) {
      ...
      StorageAccessHelper.prototype.setCookieAndRedirect = function() {
        this.setCookie('fpp.cookies_persist=true');
